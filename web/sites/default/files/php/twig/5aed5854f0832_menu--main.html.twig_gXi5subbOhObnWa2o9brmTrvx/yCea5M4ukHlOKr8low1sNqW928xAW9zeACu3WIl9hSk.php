...
/* themes/contrib/umami/templates/components/navigation/menu--main.html.twig */
class __TwigTemplate_54fd791e833f21dabc99cb36a70e70556340a474157e46b6d5339ad5b9fbe841 extends Twig_Template
{
...
";
    ...
    public function getmenu_links($__items__ = null, $__attributes__ = null, $__menu_level__ = null, $__menu_name__ = null, ...$__varargs__)
    {
        ...
        try {
            ...
            echo "  ";
            // line 37
            $context["menu_classes"] = array(0 => ("menu-" . \Drupal\Component\Utility\Html::getClass(            // line 38
($context["menu_name"] ?? null))));
            ...
            echo "  ";
            // line 43
            $context["submenu_classes"] = array(0 => (("menu-" . \Drupal\Component\Utility\Html::getClass(            // line 44
($context["menu_name"] ?? null))) . "__submenu"));
            ...
            if (($context["items"] ?? null)) {
                ...
                if ((($context["menu_level"] ?? null) == 0)) {
                    // line 49
                    echo "      <ul";
                    echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute($this->getAttribute(($context["attributes"] ?? null), "addClass", array(0 => ($context["menu_classes"] ?? null)), "method"), "setAttribute", array(0 => "data-drupal-selector", 1 => "menu-main"), "method"), "html", null, true));
                    echo "> ";
                    // line 50
                    echo "    ";
                } else {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    ...
                    echo "      ";
                    // line 56
                    $context["item_classes"] = array(0 => (("menu-" . \Drupal\Component\Utility\Html::getClass(                    // line 57
($context["menu_name"] ?? null))) . "__item"), 1 => (($this->getAttribute(                    // line 58
$context["item"], "is_expanded", array())) ? ((("menu-" . \Drupal\Component\Utility\Html::getClass(($context["menu_name"] ?? null))) . "__item--expanded")) : ("")), 2 => (($this->getAttribute(                    // line 59
$context["item"], "is_collapsed", array())) ? ((("menu-" . \Drupal\Component\Utility\Html::getClass(($context["menu_name"] ?? null))) . "__item--collapsed")) : ("")), 3 => (($this->getAttribute(                    // line 60
$context["item"], "in_active_trail", array())) ? ((("menu-" . \Drupal\Component\Utility\Html::getClass(($context["menu_name"] ?? null))) . "__item--active-trail")) : ("")));
                    // line 63
                    echo "      ";
                    // line 64
                    echo "      ";
                    // line 65
                    $context["link_classes"] = array(0 => (("menu-" . \Drupal\Component\Utility\Html::getClass(                    // line 66
...
$context["item"], "title", array()), $this->getAttribute(                    // line 74
$context["item"], "url", array()), $this->getAttribute($this->getAttribute($this->getAttribute(                    // line 75
$context["item"], "attributes", array()), "removeClass", array(0 => ($context["item_classes"] ?? null)), "method"), "addClass", array(0 => ($context["link_classes"] ?? null)), "method")), "html", null, true));
  ...
  ";
    ...
    {
        return "themes/contrib/umami/templates/components/navigation/menu--main.html.twig";
    }
    ...
    {
        return new Twig_Source("", "themes/contrib/umami/templates/components/navigation/menu--main.html.twig", "/var/www/umami/web/themes/contrib/umami/templates/components/navigation/menu--main.html.twig");
    }
}
